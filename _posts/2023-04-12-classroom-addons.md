...
<img src="./assets/repair-imgs/sensor(yellow).png" height="400">

<img src="./assets/repair-imgs/advanced(blue).png" height="400">


## Replicated blocks (results not completely identical)
<img src="./assets/repair-imgs/classroom_draw.png" width="400">
...
<img src="./assets/repair-imgs/shape_line.png" align="top" width="250">

<img src="./assets/repair-imgs/diagonal_classroom.png" height="500">

### Display Shape: Line (Vertical & Horizontal)
<img src="./assets/repair-imgs/shape_line.png" align="top" width="250">

<img src="./assets/repair-imgs/vertical_horizontal_classroom.png" height="500">

### Display Shape: Rectangle
<img src="./assets/repair-imgs/shape_rectangle.png" align="top" width="250">

<img src="./assets/repair-imgs/rectangle_classroom.png" width="500">
<br>To fill drawn rectangle, set `fill` to 1.

### Display Shape: Circle 
<img src="./assets/repair-imgs/shape_circle.png" align="top" width="250">

<img src="./assets/repair-imgs/circle_classroom.png" height="500">
...
### Touch Sensor: Bumped
<img src="./assets/repair-imgs/touchSensor_bump.png" height="200">

<img src="./assets/repair-imgs/touch_classroom.png" align="top" width="500">
